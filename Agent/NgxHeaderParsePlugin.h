#ifndef __NGX_HEADERPAESE_PLUGIN_H__
#define __NGX_HEADERPAESE_PLUGIN_H__

#include "Plugin.h"

class NgxHeaderParsePlugin : public Plugin{
    public:
    NgxHeaderParsePlugin(){
        //json获取端口等信息
        path = "/usr/bin/python";
        args.push_back("python");
        args.push_back("ngxHeaderParse.py");
    }
...
class NgxHeaderParsePluginFactory : public PluginFactory{
    public:
    virtual Plugin *createPlugin(){
        return new NgxHeaderParsePlugin();
    }
};
