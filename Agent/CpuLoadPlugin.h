#ifndef __NGX_CPULOAD_PLUGIN_H__
#define __NGX_CPULOAD_PLUGIN_H__

#include "Plugin.h"

class CpuLoadPlugin : public Plugin{
    public:
    CpuLoadPlugin(){
        //json获取端口等信息
        path = "/usr/bin/python";
        args.push_back("python");
        args.push_back("cpuLoad.py");
    }
...
class CpuLoadPluginFactory : public PluginFactory{
    public:
    virtual Plugin *createPlugin(){
        return new CpuLoadPlugin();
    }
};
