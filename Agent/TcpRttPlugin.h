#ifndef __TCP_RTT_PLUGIN_H__
#define __TCP_RTT_PLUGIN_H__

#include "Plugin.h"

class TcpRttPlugin : public Plugin{
    public:
    TcpRttPlugin(){
        //json获取端口等信息
        path = "/usr/bin/python";
        args.push_back("python");
        args.push_back("tcprtt.py");
    }
...
class TcpRttPluginFactory : public PluginFactory{
    public:
    virtual Plugin *createPlugin(){
        return new TcpRttPlugin();
    }
};
