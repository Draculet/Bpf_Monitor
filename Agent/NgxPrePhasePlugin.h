#ifndef __NGX_PREPHASE_PLUGIN_H__
#define __NGX_PREPHASE_PLUGIN_H__

#include "Plugin.h"

class NgxPrePhasePlugin : public Plugin{
    public:
    NgxPrePhasePlugin(){
        //json获取端口等信息
        path = "/usr/bin/python";
        args.push_back("python");
        args.push_back("ngxPrePhase.py");
    }
...
class NgxPrePhasePluginFactory : public PluginFactory{
    public:
    virtual Plugin *createPlugin(){
        return new NgxPrePhasePlugin();
    }
};
