#ifndef __TCP_FLOWPlUGIN_H__
#define __TCP_FLOWPlUGIN_H__

#include "Plugin.h"

class TcpFlowPlugin : public Plugin{
    public:
    TcpFlowPlugin(){
        //json获取端口等信息
        path = "/usr/bin/python";
        args.push_back("python");
        args.push_back("tcpflow.py");
    }
...
class TcpFlowPluginFactory : public PluginFactory{
    public:
    virtual Plugin *createPlugin(){
        return new TcpFlowPlugin();
    }
};
