#ifndef __TCP_SSTHRESH_PLUGIN_H__
#define __TCP_SSTHRESH_PLUGIN_H__

#include "Plugin.h"

class TcpSsthreshPlugin : public Plugin{
    public:
    TcpSsthreshPlugin(){
        //json获取端口等信息
        path = "/usr/bin/python";
        args.push_back("python");
        args.push_back("tcpssthresh.py");
    }
...
class TcpSsthreshPluginFactory : public PluginFactory{
    public:
    virtual Plugin *createPlugin(){
        return new TcpSsthreshPlugin();
    }
};
