#ifndef __NGX_FILEIO_PLUGIN_H__
#define __NGX_FILEIO_PLUGIN_H__

#include "Plugin.h"

class NgxFileIOPlugin : public Plugin{
    public:
    NgxFileIOPlugin(){
        //json获取端口等信息
        path = "/usr/bin/python";
        args.push_back("python");
        args.push_back("ngxFileIO.py");
    }
...
class NgxFileIOPluginFactory : public PluginFactory{
    public:
    virtual Plugin *createPlugin(){
        return new NgxFileIOPlugin();
    }
};
