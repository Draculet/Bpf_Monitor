#ifndef __TCP_CWND_PLUGIN_H__
#define __TCP_CWND_PLUGIN_H__

#include "Plugin.h"

class TcpCwndPlugin : public Plugin{
    public:
    TcpCwndPlugin(){
        //json获取端口等信息
        path = "/usr/bin/python";
        args.push_back("python");
        args.push_back("tcpcwnd.py");
    }
...
class TcpCwndPluginFactory : public PluginFactory{
    public:
    virtual Plugin *createPlugin(){
        return new TcpCwndPlugin();
    }
};
